        ...
        <div class=" border bg-gray-50  ">
            <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16">
                ...
                <div
                    ...
                    <div class="p-5">
                        <a href="#">
                            <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Room one
                            </h5>
                        </a>
                        <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Lorem ipsum dolor sit amet
                            consectetur, adipisicing elit. Neque laborum non vitae a voluptatibus officia deleniti eius
                            explicabo vero est assumenda dolor ab, accusamus, nostrum, cum iure cumque similique culpa.
                        </p>
                        <a href="#"
